        ...
        <div className='learning-path'>
          ...
          <ol class="timeline">
            ...
            <li class="timeline-item">
              ...
              <div class="timeline-item-description">
                ...
                <span><a style={{color:"black"}} className='learned-course-lesson-title' href="https://www.coursera.org/learn/machine-learning?specialization=machine-learning-introduction">Suprevised Machine Learning Regression and Classification</a> •-• <a href="https://www.coursera.org/instructor/andrewng">Andrew Ng</a> •-• <time datetime="21-01-2021">Dec 21, 2023</time></span>
              </div>
            </li>
          ...
          <ol class="timeline">
            ...
            <li class="timeline-item">
              ...
              <div class="timeline-item-description">
              <span><a href="https://www.kaggle.com/learn">Kaggle's</a> - <a style={{color:"black"}} className='learned-course-title' href="https://www.kaggle.com/learn">🤖 Courses 🤖</a></span>
              </div>
            </li>
            ...
            <li class="timeline-item">
              ...
              <div class="timeline-item-description">
                ...
                <span> <a href="https://www.kaggle.com/learn/intro-to-machine-learning" style={{color:"black"}} className='learned-course-lesson-title' >Intro to Machine Learning </a>•-• <time datetime="21-01-2021">Jan 14, 2024</time></span>
              </div>
            </li>
            {/*PANDAS - COURSE*/}
            <li class="timeline-item">
              ...
              <div class="timeline-item-description">
                ...
                <span> <a href="https://www.kaggle.com/learn/pandas" style={{color:"black"}} className='learned-course-lesson-title'>Pandas</a> •-• <time datetime="20-01-2021">Jan 15, 2024</time></span>
              </div>
            </li>
            {/*INTERM-ML - COURSE*/}
            <li class="timeline-item">
              ...
              <div class="timeline-item-description">
                ...
                <span> <a href="https://www.kaggle.com/learn/intermediate-machine-learning" style={{color:"black"}} className='learned-course-lesson-title'>Intermediate Machine Learning</a> •-• <time datetime="20-01-2021">Jan 14, 2024</time></span>
              </div>
            </li>
            {/*INTRO-DL - COURSE*/}
            <li class="timeline-item">
              ...
              <div class="timeline-item-description">
                ...
                <span> <a href="https://www.kaggle.com/learn/intro-to-deep-learning" style={{color:"black"}} className='learned-course-lesson-title'>Intro to Deep Learning</a> •-• <time datetime="20-01-2021">Jan 16, 2024</time></span>
              </div>
            </li>
