...
import { AmazonwebservicesOriginalWordmark, AndroidOriginal, AppleOriginal, CplusplusOriginal, Css3Original, DockerOriginal, DockerOriginalWordmark, ExpressOriginal, ExpressOriginalWordmark, FirebaseOriginal, FlaskOriginal, GoOriginal, Html5Original, JavaOriginal, JavascriptOriginal, NextjsOriginal, NodejsOriginal, PythonOriginal, ReactOriginal, ReactOriginalWordmark, SqliteOriginal, SqlitePlain, TailwindcssOriginal, TypescriptOriginal, VitejsOriginal, ViteOriginal } from 'devicons-react';
      ...
      {selectedFullstack === 'web' ? (
        ...
        <div className="flex flex-col mt-10 items-center p-5 bg-gray-900 rounded lg:flex-row lg:justify-between animated-bg">
                    ...
                    <div className="flex flex-wrap justify-center items-center p-5 bg-gray-900 rounded" style={{backgroundColor:"rgba(0,0,0,0.4)"}}>
                        ...
                        <SqlitePlain className='m-3 mx-4' size={35} />
                        </div>
                </div>
        </>
      ):(
        ...
        <ol class="timeline">
          ...
          <li class="timeline-item">
            ...
            <div class="timeline-item-description">
              <span><a href="https://www.udemy.com/course/the-complete-web-development-bootcamp/?couponCode=ACCAGE0923" className='learned-course-title text-xs md:text-lg' style={{color:"white"}}>📚 Vrije 📚</a></span>
            </div>
          </li>
