...
var require_LexicalClipboard_dev = __commonJS({
  "node_modules/@lexical/clipboard/LexicalClipboard.dev.js"(exports) {
    ...
    function $insertGeneratedNodes(editor, nodes, selection2) {
      const isGridSelection = lexical.DEPRECATED_$isGridSelection(selection2);
      const isRangeSelection = lexical.$isRangeSelection(selection2);
      const isSelectionInsideOfGrid = isGridSelection || isRangeSelection && utils.$findMatchingParent(selection2.anchor.getNode(), (n) => lexical.DEPRECATED_$isGridCellNode(n)) !== null && utils.$findMatchingParent(selection2.focus.getNode(), (n) => lexical.DEPRECATED_$isGridCellNode(n)) !== null;
  ...
  "node_modules/@lexical/rich-text/LexicalRichText.dev.js"(exports) {
    ...
    function onPasteForRichText(event, editor) {
      ...
      editor.update(() => {
        ...
        if (clipboardData != null && lexical.$INTERNAL_isPointSelection(selection2)) {
    ...
    function registerRichText(editor) {
      const removeListener = utils.mergeRegister(editor.registerCommand(lexical.CLICK_COMMAND, (payload) => {
        ...
        if (typeof eventOrText === "string") {
          if (lexical.$INTERNAL_isPointSelection(selection2)) {
...
//# sourceMappingURL=chunk-47T7ESIR.js.map
