...
var require_Lexical_dev = __commonJS({
  "node_modules/lexical/Lexical.dev.js"(exports) {
    ...
    var INTERNAL_PointSelection = class {
    ...
    var GridSelection = class _GridSelection extends INTERNAL_PointSelection {
    ...
    var RangeSelection = class _RangeSelection extends INTERNAL_PointSelection {
    ...
    function removeTextAndSplitBlock(selection) {
      ...
      if (firstToAppend) {
        const newBlock = pointParent.insertNewAfter(selection);
...
//# sourceMappingURL=chunk-OOMKOIZE.js.map
