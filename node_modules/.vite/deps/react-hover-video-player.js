...
function HoverVideoPlayer(_a) {
  ...
  return import_react.default.createElement(
    ...
    hasPausedOverlay ? import_react.default.createElement(
      "div",
      {
    ...
    hasLoadingOverlay ? import_react.default.createElement(
      "div",
      {
    ...
    hasHoverOverlay ? import_react.default.createElement(
      "div",
      {
        style: __spreadValues(__spreadValues(__spreadProps(__spreadValues({}, expandToFillContainerStyle), {
          zIndex: 3
...
react-hover-video-player/dist/index.mjs:
  (**
